    ...
    ...toCreate.map((s) =>
      prisma.soldier.create({
        data: {
          ...
          emergencyContactRelationship: s.emergencyContactRelationship ?? null,
    ...
    ...toUpdate.map(({ id, data: s }) =>
      prisma.soldier.update({
        ...
        data: {
          ...
          phone: s.phone ? (toE164(s.phone) ?? null) : null,
          emergencyPhone: s.emergencyPhone ? (toE164(s.emergencyPhone) ?? null) : null,
          ...(s.emergencyContactName !== undefined ? { emergencyContactName: s.emergencyContactName ?? null } : {}),
          ...(s.emergencyContactRelationship !== undefined ? { emergencyContactRelationship: s.emergencyContactRelationship ?? null } : {}),
