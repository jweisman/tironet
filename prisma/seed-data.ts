/**
 * Shared seed data used by both e2e tests and the standalone seed-test script.
 * Entity definitions live here; orchestration (DB connection, migrations,
 * invitation tokens, token files) lives in the consumer scripts.
 */
 ...
 */
export async function teardownData(prisma: PrismaClient) {
...
/**
 * Seed the core entities (users, structure, soldiers, activities, reports,
 * requests). Does NOT create invitations — those are e2e-specific.
 */
